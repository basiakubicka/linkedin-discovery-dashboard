  ...
  signUp: {
    ...
    legalConsent: {
      checkbox: {
        ...
        label__termsOfServiceAndPrivacyPolicy: 'Souhlas\xEDm s {{ termsOfServiceLink || link("podm\xEDnkami slu\u017Eby") }} a {{ privacyPolicyLink || link("politikou ochrany osobn\xEDch \xFAdaj\u016F") }}'
      },
      continue: {
